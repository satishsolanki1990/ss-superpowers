...
git clone https://github.com/satishsolanki1990/ss-superpowers.git ~/.config/opencode/superpowers
```
...
- Documentation: https://github.com/satishsolanki1990/ss-superpowers
```
